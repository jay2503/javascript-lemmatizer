...
var Lemmatizer = function () {
  this.wn_files = {
    noun: [
      '/bower_components/JavaScript%20Lemmatizer/dict/index.noun.json',
      '/bower_components/JavaScript%20Lemmatizer/dict/noun.exc.json'
    ],
    verb: [
      '/bower_components/JavaScript%20Lemmatizer/dict/index.verb.json',
      '/bower_components/JavaScript%20Lemmatizer/dict/verb.exc.json'
    ],
    adj: [
      '/bower_components/JavaScript%20Lemmatizer/dict/index.adj.json',
      '/bower_components/JavaScript%20Lemmatizer/dict/adj.exc.json'
    ],
    adv: [
      '/bower_components/JavaScript%20Lemmatizer/dict/index.adv.json',
      '/bower_components/JavaScript%20Lemmatizer/dict/adv.exc.json'
    ]
  };
